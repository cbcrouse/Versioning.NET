...
public class IncrementVersionWithGitHandlerTests
{
    ...
    public async Task Handler_ExitsWhen_IncrementIsNone()
    {
        ...
        // Act
        await sut.Handle(new IncrementVersionWithGitCommand { VersionIncrement = VersionIncrement.None }, CancellationToken.None);
    ...
    public async Task Handler_ExitsWhen_IncrementIsUnknown()
    {
        ...
        // Act
        await sut.Handle(new IncrementVersionWithGitCommand { VersionIncrement = VersionIncrement.Unknown }, CancellationToken.None);
