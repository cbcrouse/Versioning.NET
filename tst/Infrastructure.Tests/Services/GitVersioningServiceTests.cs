...
public class GitVersioningServiceTests
{
    public static IEnumerable<object[]> VersionData
    {
        get
        {
            return
            [
                [new[] {"v2.2.4", "v2.2.5", "v2.2.6" }, "2.2.6"], // Patch
                [new[] {"v2.2.4", "v2.2.5", "v2.3.0" }, "2.3.0"], // Minor
                [new[] {"v2.2.4", "v2.2.5", "v2.2.6" }, "2.2.6"], // Major
                [new[] {"v2.4.0-alpha", "v2.4.0-beta", "v2.4.0-rc" }, "2.4.0-rc"], // PreRelease
                [new[] {"v2.4.0-beta.81", "v2.4.0-beta.82", "v2.4.0-beta.99" }, "2.4.0-beta.99"], // Build
                [new[] {"v2.4.0-alpha.70", "v2.4.0-beta.81", "v2.4.0-beta.99", "v2.4.0-rc.103" }, "2.4.0-rc.103"], // PreRelease + Build
                [new[] {"v3.0.0-alpha.268", "v3.0.0-rc.289", "v3.0.0" }, "3.0.0"] // PreRelease + MajorRelease
            ];
        }
    }
