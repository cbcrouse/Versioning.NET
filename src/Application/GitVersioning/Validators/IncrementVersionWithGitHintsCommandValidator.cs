...
/// </summary>
public class IncrementVersionWithGitHintsCommandValidator : AbstractValidator<IncrementVersionWithGitHintsCommand>
{
    /// <summary>
    /// Default Constructor
    /// </summary>
    public IncrementVersionWithGitHintsCommandValidator()
    {
